 ...
 *
 * @param string $param Représente le nom de l'élément stocké dans la session. Ca peur être le nom, l'email ou meme l'id et bien d'autres informations concernant l'utilisateur connecté.
 *
 ...
 */
function ds_info(string $param): ?string {
